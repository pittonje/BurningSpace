...
Accepted decision records now exist after DOCARCH-002B1, DOCARCH-002B2, DOCARCH-002C1, and DOCARCH-002C2. CI-003-D1 remains pending for DOCARCH-002C3. Each individual record is authoritative within its accepted scope.
